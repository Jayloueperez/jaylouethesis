...
interface TalentDetailsFacultyMembersProps {
  talent: TalentSchema;
}

function TalentDetailsFacultyMembers(props: TalentDetailsFacultyMembersProps) {
  const { talent } = props;
...
export { TalentDetailsFacultyMembers };

...
interface TalentDetailsTeacherAnnouncementsProps {
  talent: TalentSchema;
}

function TalentDetailsTeacherAnnouncements(
  props: TalentDetailsTeacherAnnouncementsProps,
) {
  const { talent } = props;
...
export { TalentDetailsTeacherAnnouncements };

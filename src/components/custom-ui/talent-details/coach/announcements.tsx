...
interface TalentDetailsCoachAnnouncementsProps {
  talent: TalentSchema;
}

function TalentDetailsCoachAnnouncements(
  props: TalentDetailsCoachAnnouncementsProps,
) {
  const { talent } = props;
...
export { TalentDetailsCoachAnnouncements };

...
interface TalentDetailsCoachMembersProps {
  talent: TalentSchema;
}

function TalentDetailsCoachMembers(props: TalentDetailsCoachMembersProps) {
  const { talent } = props;
  ...
  let applicationsUrl = `/coach/${talentType}/${talentId}/applicants`;

  if (talent.node === "child") {
    applicationsUrl = `/coach/${talentType}/${talent.parentId}/event/${talent.id}/applicants`;
  }
...
export { TalentDetailsCoachMembers };
